    ...
    <div className="h-full w-full z-1 absolute flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 h-[80%] md:h-full flex items-center justify-center">
        ...
        >
          ...
          >
            <h1 className="capitalize text-[5vw] md:text-[2.5vw] font-semibold">Signup</h1>
            <form onSubmit={onSubmitHandler} method="POST" className="mt-5 md:mt-10 w-full px-[10%]">
            <input
                ...
                required
                className="bg-black w-full border-[1px] border-white px-6 py-2 md:py-3 mb-4 rounded-xl text-[3vw] md:text-[1.25vw] placeholder:text-white"
              />
              <input
                onChange={handleInput}
                value={user.email}
              ...
              <input
                ...
                required
                className="bg-black w-full border-[1px] border-white px-6 py-2 md:py-3 rounded-xl text-[3vw] md:text-[1.25vw] placeholder:text-white mt-4"
              />
              <button
                id="submit-btn"
                type="submit"
                className="w-full px-4 py-2 rounded-xl text-[3vw] md:text-[1.5vw] font-semibold border-2 border-white mt-6"
              >
                SignUp
              </button>
            </form>
...
export default ForegroundSignup;
